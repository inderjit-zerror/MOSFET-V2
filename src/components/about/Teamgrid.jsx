...
export default function TeamGrid() {
  ...
  return (
    <section className="BGTint  px-4 sm:px-6">
      <div className="col-span-1 md:col-span-4 flex flex-col items-center text-center py-[8vw] sm:py-[6vw] md:py-[4vw] px-[2vw] sm:px-[4vw] border-b border-gray-200">
        <InTitle txt={"Leadership"} />
        ...
        <p className="paragraph max-w-[38rem] PH ">
          Engineers, designers, and operators building automotive tech from the ground up, based in Delhi and working directly with fleets, dealers, and OEM partners across India to bring MOSFET's products to the road.
        </p>
      </div>

      {/* <GridLine /> */}

      <div className="mx-auto max-w-[95vw] sm:max-w-[93vw] py-[6vw] sm:py-0">
        <div
          className="
            grid
            grid-cols-1
