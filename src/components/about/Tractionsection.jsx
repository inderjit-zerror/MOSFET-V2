...
const newsItems = [
  {
    date: "June 15, 2026",
    title:
      "MOSFET Launches AI-Enabled RoadEye Dash Cam Series",
    href: "#",
    image: "https://images.unsplash.com/photo-1616761879141-f485e5fed5df?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Y2FyJTIwYWNjZXNzb3JpZXN8ZW58MHx8MHx8fDA%3D",
    imageAlt: "CURA and BBA Engineering team on site",
  },
  {
    date: "April 29, 2026",
    title: " MOSFET Partners With [OEM Name] to Supply Vehicle Safety Systems",
    href: "#",
    image: "https://images.unsplash.com/photo-1592570714618-15e2d4719c6c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Y2FyJTIwYWNjZXNzb3JpZXN8ZW58MHx8MHx8fDA%3D",
    imageAlt: "CURA and NorthX Climate Tech team",
  },
  {
    date: "April 28, 2026",
    title:
      "MOSFET Expands Retail Network Across India",
    href: "#",
    image: "https://images.unsplash.com/photo-1633484727830-c1cc0885251e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Y2FyJTIwYWNjZXNzb3JpZXMlMjBpbm5lcnxlbnwwfHwwfHx8MA%3D%3D",
    imageAlt: "Better Buildings Adoption Accelerator cohort announcement",
  },
...
export default function TractionSection() {
  return (
    <section className="BGTint w-full h-fit px-4 pt-12 sm:px-6 sm:pt-16 md:px-10 md:pt-20 ">

      <div className="mx-auto grid  grid-cols-1 gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-16">
        {/* Left column */}
        <div>
          <InTitle txt={'Traction'} />
        ...
        {/* Right column */}
        <div className="border-t border-[#D8D5CB] max-sm:pt-5">
          {newsItems.map((item) => (
            <Link
              key={item.title}
              href={item.href}
              className="group flex items-center gap-3 sm:gap-6 border-b border-[#D8D5CB] py-5 sm:py-8 first:pt-0"
            >
              {/* Thumbnail */}
              <div className="relative h-16 w-16 shrink-0 overflow-hidden bg-[#1A1A1A] sm:h-24 sm:w-24 md:h-28 md:w-28">
                <img
                  src={item.image}
                  alt={item.imageAlt}
              ...
              <div className="shrink-0">
                <ArrowRight
                  className="h-5 w-5 sm:h-6 sm:w-6 TextRed transition-transform duration-200 group-hover:translate-x-1"
                  strokeWidth={2}
                />
              </div>
            </Link>
