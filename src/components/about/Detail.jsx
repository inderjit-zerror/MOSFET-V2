...
//       <div
//         ref={pinRef}
//         className=" sticky top-0 left-0 flex h-[100vh] w-full items-center justify-center overflow-hidden BGRed"
//       >
//        <GridLine/>
...
//           <InTitle2 txt={"Cement emissions are no longer abstract."} />

//           <div className="relative w-full">
//             <p
//               ref={paraOneRef}
//               className="absolute inset-0 m-0 text-[2.75rem] font-medium leading-[1.25] TextTint"
//             >
//               {PARAGRAPH_ONE}
//             </p>
...
//             <p
//               ref={paraTwoRef}
//               className="invisible m-0 text-[2.75rem] font-medium leading-[1.25] TextTint"
//             >
...
export default function Detail() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full  h-[200vh] overflow-hidden z-99 BGRed"
      ...
      >
       <GridLine/>
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 left-0 hidden sm:block w-[26vw] sm:w-[22vw] max-w-none select-none opacity-90"
        />
        <img
          src="/images/cura-bridge.png"
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 right-0 hidden sm:block w-[28vw] sm:w-[24vw] max-w-none select-none opacity-90"
        />

        <div className="relative z-10 mx-auto flex w-[90vw] sm:w-[80vw] md:w-[70vw] max-w-[64rem] flex-col items-center text-center">
          <InTitle2 txt={"Built to Perform, Not Just Impress"} />

          <div className="relative w-full">
            <p
              ref={paraOneRef}
              className="absolute inset-0 m-0 text-[1.4rem] sm:text-[1.9rem] md:text-[2.3rem] lg:text-[2.75rem] font-medium leading-[1.3] TextTint"
            >
              {PARAGRAPH_ONE}
            </p>
            ...
            <p
              ref={paraTwoRef}
              className="invisible m-0 text-[1.4rem] sm:text-[1.9rem] md:text-[2.3rem] lg:text-[2.75rem] font-medium leading-[1.3] TextTint"
            >
              {PARAGRAPH_TWO_PARTS.before}
              <sub className="bottom-0 text-[0.9rem] sm:text-[1.2rem] lg:text-[1.75rem]">2</sub>
              {PARAGRAPH_TWO_PARTS.after}
            </p>
          </div>
        </div>
