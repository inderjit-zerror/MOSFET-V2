...
export default function AboutDetail() {
  ...
  return (
    <section className="relative w-full px-[6vw] sm:px-[8vw] md:px-[10vw] py-[6vh] sm:py-[8vh] md:py-[10vh] BGTint ">
      <div className="col-span-1 md:col-span-4 flex flex-col items-center text-center pb-[4vh] sm:pb-[5vh]  px-[2vw] sm:px-[4vw] border-b border-gray-200">

        <InTitle txt={' Engineering First'} />
      ...
      <div className="grid grid-cols-1 h-auto md:h-[95svh] md:grid-cols-2 ">
        {/* Left: Image */}
        <div className="relative aspect-[4/3] sm:aspect-[16/9] bg-[#ECEEE9]/90 w-full overflow-hidden md:aspect-auto md:min-h-[650px]">
          <div
            ref={imageRef}
            className="absolute inset-0 bg-cover bg-center"
            style={{ backgroundImage: `url(${slide.image})` }}
        ...
        {/* Right: Content */}
        <div className="relative flex min-h-[320px] sm:min-h-[400px] flex-col  items-center justify-center BGRed px-5 py-10 sm:px-7 sm:py-16 text-center md:min-h-[650px]">
          {/* <div
            ref={iconRef}
            className="mb-8 flex h-16 w-16 items-center justify-center rounded-xl border border-[#e8552f]/60"
          >
          ...
          <h2
            ref={titleRef}
            className="max-w-[95%] sm:max-w-[90%] heading1 text-[1.5rem]! sm:text-[1.75rem]! md:text-[2rem]! font-semibold leading-[1.15] TextTint"
          >
            {slide.title}
          </h2>
          ...
          <p
            ref={descRef}
            className="mx-auto paragraph mt-4 sm:mt-6 max-w-[95%] sm:max-w-[90%] text-[0.9rem] sm:text-[1rem] leading-[1.6] text-justify TextTint"
          >
            {slide.description}
          </p>
