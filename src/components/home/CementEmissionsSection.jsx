...
export default function CementEmissionsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full  h-[200vh] overflow-hidden z-99 bg-[#F7F7F1]"
      ...
      >
       {/* <GridLine/> */}
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 left-0 w-[30vw] sm:w-[22vw] max-w-none select-none opacity-60 sm:opacity-90"
        />
        <img
          src="/images/cura-bridge.png"
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 right-0 w-[32vw] sm:w-[24vw] max-w-none select-none opacity-60 sm:opacity-90"
        />
        ...
        <div className="relative z-10 mx-auto flex w-[90vw] sm:w-[80vw] max-w-[64rem] flex-col items-center text-center">
          ...
          <div className="relative w-full">
            <p
              ref={paraOneRef}
              className="absolute inset-0 m-0 text-[1.5rem] sm:text-[2rem] lg:text-[2.75rem] font-medium leading-[1.25] text-black"
            >
              {PARAGRAPH_ONE}
            </p>
            ...
            <p
              ref={paraTwoRef}
              className="invisible m-0 text-[1.5rem] sm:text-[2rem] lg:text-[2.75rem] font-medium leading-[1.25] text-black"
            >
              {PARAGRAPH_TWO_PARTS.before}
