    ...
    >
      ...
      <div className="relative mx-auto max-w-[1900px] px-6 py-20 sm:px-10 lg:px-[3vw] lg:py-[9vh]">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-[minmax(0,500px)_1fr] lg:gap-[7.5vw] ">
          ...
          {/* Right: paginated card viewport */}
          <div ref={viewportRef} className="relative overflow-hidden ml-auto w-full lg:w-[46vw]">
            <div
              ref={trackRef}
              className="flex gap-6 lg:gap-[1.4vw]"
              style={{
          ...
          <div className="flex gap-3 lg:hidden">
            ...
            <button
              ...
              disabled={!canGoNext}
              aria-label="Next milestone"
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#EE2F2F] text-white disabled:opacity-40"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                <path
                  d="M5 12h14m0 0l-7-7m7 7l-7 7"
