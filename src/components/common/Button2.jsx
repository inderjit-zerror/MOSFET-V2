...
const Button2 = ({ txt }) => {
  return (
    <button className="relative overflow-hidden flex w-fit group items-center justify-center bg-white border-2 border-white px-[2rem] py-[0.6rem] -skew-x-[15deg] transition-all duration-300 hover:scale-[1.03] hover:shadow-lg">
