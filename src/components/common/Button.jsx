...
const Button = ({ txt }) => {
  return (
    <button className="relative overflow-hidden flex w-fit group items-center justify-center BGRed border-2 border-red-500 px-[2rem] py-[0.6rem] transition-all duration-300 hover:scale-[1.03] hover:shadow-lg">
